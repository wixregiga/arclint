...
5 contexts, 1 aggregates, 28 value objects, 25 invariants (domain.arclint.yaml).

- **vocabulary**
- **rule**: aggregates Rule (Zone, Pattern); value objects RuleID, ZoneName, Claim, Assertion, ConstraintKind, Severity, Language, PatternReference, Expansion, ExpansionSource, TermCase, CaseSpec

...
func (f failingExtensions) Evaluate(string, map[string]any, conformance.ExtensionScope,
...
func (r *recordingExtensions) Evaluate(_ string, _ map[string]any, _ conformance.ExtensionScope,

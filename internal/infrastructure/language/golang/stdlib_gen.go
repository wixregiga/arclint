// Code generated by tools/genstdlib; DO NOT EDIT.
// Source: `go list std` of go1.27.1.

package golang

// StdlibToolchain is the toolchain whose `go list std` produced the table.
const StdlibToolchain = "go1.27.1"
